...
Let's introduce some MNE-specific terminology (check out the [glossary](https://mne.tools/stable/glossary.html) for more definitions). The three most important types that represent EEG data are:

- Continuous data is represented by `Raw` objects ([official tutorial](https://mne.tools/stable/auto_tutorials/raw/10_raw_overview.html))
- Epoched data is represented by `Epochs` objects ([official tutorial](https://mne.tools/stable/auto_tutorials/epochs/10_epochs_overview.html))
- Evoked data (averaged epochs) is represented by `Evoked` objects ([official tutorial](https://mne.tools/stable/auto_tutorials/evoked/10_evoked_overview.html))
